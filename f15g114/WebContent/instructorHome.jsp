	...
	<f:view>
		...
		<center>
			<div>
				...
				<br> <br> <a href="faces/rosterUpload.jsp">Upload
					Student Roster</a><br> <a href="faces/fileUpload.jsp">Upload
					Assessment</a><br>
				<h:form>
					...
					<h:commandLink action="#{professorBean.viewAssessmentsRoster}"
						value="View Submitted Assessments">
					</h:commandLink>
					<br>
					<h:commandLink action="#{chartBean.processBarChart}"
						value="Class Statistics">
					</h:commandLink>
				</h:form>
